...
create table valoration (def int,fk_route varchar(15) references routes(name),fk_user varchar(20) references users(name));
create table comments (def text,fk_route varchar(15) references routes(name),fk_user varchar(20) references users(name));
